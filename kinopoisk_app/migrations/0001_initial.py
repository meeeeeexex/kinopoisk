    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Action', 'Action'), ('Comedy', 'Comedy'), ('Drama', 'Drama'), ('Fantasy', 'Fantasy'), ('Horror', 'Horror'), ('Mystery', 'Mystery'), ('Romance', 'Romance'), ('Thriller', 'Thriller'), ('Western', 'Western')], default='Not specified', max_length=100, verbose_name='Название')),
            ],
            options={
                'verbose_name': 'Жанр',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('film_director', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kinopoisk_app.director', verbose_name='Режиссер')),
        ...
        migrations.AddField(
            model_name='director',
            name='filmography',
            field=models.ManyToManyField(blank=True, null=True, to='kinopoisk_app.movie'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('favorite_genres', models.ManyToManyField(to='kinopoisk_app.genre', verbose_name='favourite genres')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='actor',
            name='filmography',
            field=models.ManyToManyField(to='kinopoisk_app.movie'),
        ),
    ]
