    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kinopoisk_app.movie', verbose_name='Фильм')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avaliable_movies', models.ManyToManyField(blank=True, null=True, to='kinopoisk_app.movie', verbose_name='Доступные фильмы')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, null=True, to='kinopoisk_app.genre', verbose_name='Любимые жанры'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='favorite_movies',
            field=models.ManyToManyField(blank=True, null=True, to='kinopoisk_app.movie', verbose_name='Избранные фильмы'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
