    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture_blob', models.ImageField(upload_to='photos/%Y/%m/%d/')),
                ('actor_squad', models.ManyToManyField(to='kinopoisk_app.actor')),
                ('film_director', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kinopoisk_app.filmdirector')),
            ],
            options={
                'verbose_name': 'Фильм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fav_genres', models.CharField(choices=[('Action', 'Action'), ('Comedy', 'Comedy'), ('Drama', 'Drama'), ('Fantasy', 'Fantasy'), ('Horror', 'Horror'), ('Mystery', 'Mystery'), ('Romance', 'Romance'), ('Thriller', 'Thriller'), ('Western', 'Western')], default='Not specified', max_length=100, verbose_name='Любимый жанр')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movie', to='kinopoisk_app.movie')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='kinopoisk_app.user')),
            ],
        ),
        migrations.AddField(
            model_name='movie',
            name='review',
            field=models.ManyToManyField(null=True, through='kinopoisk_app.Review', to='kinopoisk_app.user'),
        ),
        migrations.CreateModel(
            name='Cinema',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kinopoisk_app.actor')),
